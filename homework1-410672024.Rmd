...
twTime01 <- hour(twTime) >= "1"
twTime01

twTime06 <- hour(twTime) <= "6"
twTime06
nightOwl <- twTime01 & twTime06
nightOwl
...
sum(nightOwl)
length(submitTime)
sum(nightOwl)/length(submitTime)
...
```{r ans33}
earnedCredit100ChosenStudent <- sum(studentID == "046S6f645" & schoolYear == 100 & grade >= 60 ) 
